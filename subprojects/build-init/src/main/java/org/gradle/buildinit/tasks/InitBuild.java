...
public class InitBuild extends DefaultTask {
    ...
    private String type;
    private final Property<Boolean> modularized = getProject().getObjects().property(Boolean.class).convention(false);
    private String dsl;
    ...
    @Incubating
    @Input
    @Option(option = "modularized", description = "Should the build be modularized?")
    public Property<Boolean> getModularized() {
        return modularized;
    }
    ...
    public void setupProjectLayout() {
        ...
        String no = "No";
        String yes = "Yes";
        boolean modularized = this.modularized.getOrElse(
            initDescriptor.supportsModularization() && inputHandler.selectOption("Modularize project?", Arrays.asList(yes, no), no).equals(yes)
        );
        ...
        initDescriptor.generate(new InitSettings(projectName, subprojectNames,
            modularized, dsl, packageName, testFramework, projectDir));
